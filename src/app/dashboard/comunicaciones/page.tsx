...
export default function CommunicationsPage() {
  ...
  const filteredCommunications = communications.filter(comm => {
    if (filterCourse && !comm.targetCourses.includes(filterCourse)) return false;
    if (filterSubject && !comm.targetSubjects.includes(filterSubject)) return false;
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <Select value={filterCourse} onValueChange={setFilterCourse}>
                  ...
                  <SelectContent>
                    <SelectItem value="">{translate('allCourses')}</SelectItem>
                    {myCourses.map(course => (
                ...
                <Select value={filterSubject} onValueChange={setFilterSubject}>
                  ...
                  <SelectContent>
                    <SelectItem value="">{translate('allSubjects')}</SelectItem>
                    {mySubjects.map(subject => (
                ...
                <Select value={filterType} onValueChange={setFilterType}>
                  ...
                  <SelectContent>
                    <SelectItem value="">{translate('allTypes')}</SelectItem>
                    {Object.entries(communicationTypes).map(([key, type]) => (
                ...
                <Select value={filterStatus} onValueChange={setFilterStatus}>
                  ...
                  <SelectContent>
                    <SelectItem value="">{translate('allStatuses')}</SelectItem>
